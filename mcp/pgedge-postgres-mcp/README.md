...
- **[Dockerfile.server](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/Dockerfile.server)** - MCP server with PostgreSQL
  tools
- **[Dockerfile.cli](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/Dockerfile.cli)** - Command-line chat client
- **[Dockerfile.web](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/Dockerfile.web)** - React-based web UI with Nginx
...
The repository includes a [docker-compose.yml](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/docker-compose.yml) file for
...
See [examples/.env.example](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/examples/.env.example) for all configuration
...
[examples/helm/pgedge-nla/](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/examples/helm/pgedge-nla).
...
- **[values.yaml](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/examples/helm/pgedge-nla/values.yaml)** - Default
  configuration for development/testing
- **[values-production.yaml](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/examples/helm/pgedge-nla/values-production.yaml)**
...
See the [Helm chart README](https://github.com/pgEdge/pgedge-postgres-mcp/blob/main/examples/helm/pgedge-nla/README.md) for complete
documentation.
