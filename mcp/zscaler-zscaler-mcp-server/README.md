...
For the full catalog (29 toolsets across all services), filter precedence rules, per-toolset agent guidance, and the complete reference, see [docs/guides/toolsets.md](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/toolsets.md).
...
> **📖 Full Documentation: [Authentication & Deployment Guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md)**
...
> **📖 For detailed setup instructions — including [OIDCProxy setup with Auth0/Okta/Azure AD](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md#oidcproxy-setup-oauth-21--dcr), [Microsoft Entra ID step-by-step guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/entra-id-oidcproxy.md), IdP-specific JWKS configuration, Docker deployment examples, client configuration for Claude/Cursor/VS Code, and troubleshooting — see the [Authentication & Deployment Guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md).**
...
📖 **[View Complete Tools Reference →](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/supported-tools.md)**
...
- `--toolsets`: Comma-separated toolset ids to enable (e.g. `zia_url_filtering,zpa_app_segments`). Special values: `default` (curated default-on subset), `all` (every toolset). When unspecified, every toolset whose service is enabled is loaded. See [docs/guides/toolsets.md](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/toolsets.md).
...
> **📖 Full remote deployment details** (venv usage, 421 troubleshooting, security, TLS): [Remote Deployment](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md#remote-deployment-ec2-vm-etc) · [421 Misdirected Request](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/authentication-and-deployment.md#421-misdirected-request-invalid-host-header) · [Troubleshooting](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/TROUBLESHOOTING.md#remote-mcp-421-misdirected-request)
...
> **📖 Full Azure deployment guide**: [integrations/azure/README.md](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/azure/README.md)
...
> **📖 Full Google Cloud deployment guide** (all five targets, IAM roles, authentication modes, enterprise patterns): [integrations/google/README.md](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/google/README.md)
>
> **📖 Secret Manager deep-dive** (GKE manifests, credential rotation, loader internals): [GCP Secret Manager Integration](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/gcp_secrets_manager_integration.md)
...
For the full chart reference (`values.yaml` keys, Ingress / HTTPRoute / cert-manager / HPA / PDB toggles, ExternalSecret examples), see [`integrations/helm-chart/README.md`](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/helm-chart/README.md).
...
For detailed deployment instructions, IAM configuration, and troubleshooting, please refer to the comprehensive [Amazon Bedrock AgentCore deployment guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/deployment/amazon_bedrock_agentcore.md).
...
- **Windows: `ModuleNotFoundError` (rpds, pydantic_core, etc.)**: The extension bundles macOS/Linux binaries. Use Option 2 (Manual Configuration) instead. See [Troubleshooting guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/TROUBLESHOOTING.md#windows-claude-desktop-extension-fails-to-start).
...
|----------|------|------------|---------|
| **Claude Code** | Plugin | `claude plugin install zscaler` | [integrations/claude-code-plugin/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/claude-code-plugin/README.md) |
| **Cursor** | Plugin | Settings → Tools & MCP → New MCP Server | [integrations/cursor-plugin/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/cursor-plugin/README.md) |
| **Gemini CLI** | Extension | Register `gemini-extension.json` | [integrations/gemini-extension/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/gemini-extension/README.md) |
| **Kiro IDE** | Power | Powers panel → Add Custom Power | [integrations/kiro/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/kiro/README.md) |
| **Azure (Container Apps / VM)** | Deployment + Agent | `python azure_mcp_operations.py deploy` | [integrations/azure/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/azure/README.md) |
| **Google Cloud (Cloud Run / GKE / VM)** | Deployment | `python gcp_mcp_operations.py deploy` | [integrations/google/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/google/README.md) |
| **Google ADK Agent** | Agent | `python adk_agent_operations.py deploy` | [integrations/google/adk/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/google/adk/README.md) |
| **Kubernetes (Helm Chart)** | Deployment | `python helm_mcp_operations.py deploy` | [integrations/helm-chart/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/helm-chart/README.md) |
| **GitHub MCP Registry** | Registry | `mcp-publisher publish` | [integrations/github/](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/github/README.md) |

For full documentation on all integrations, see the [Platform Integrations Guide](https://github.com/zscaler/zscaler-mcp-server/blob/master/integrations/README.md).
...
6. **Windows: `ModuleNotFoundError: No module named 'rpds.rpds'`** (Claude Desktop extension)
   ...
   - See [Troubleshooting: Windows](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/TROUBLESHOOTING.md#windows-claude-desktop-extension-fails-to-start).
...
7. **Windows: `'C:\Program' is not recognized`** (Remote MCP with `npx`)
   ...
   - See [Troubleshooting: Windows npx path issues](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/TROUBLESHOOTING.md#windows-npx-path-with-spaces).
...
8. **`Non-HTTPS URLs are only allowed for localhost`** (mcp-remote)
   ...
   - See [Troubleshooting: mcp-remote HTTPS enforcement](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/TROUBLESHOOTING.md#mcp-remote-non-https-url-rejected).
...
9. **`self-signed certificate` / `DEPTH_ZERO_SELF_SIGNED_CERT`** (mcp-remote with TLS)
   ...
   - See [Troubleshooting: Self-signed certificates](https://github.com/zscaler/zscaler-mcp-server/blob/master/docs/guides/TROUBLESHOOTING.md#self-signed-certificate-rejected-by-mcp-remote).
