...
See [FAQ.md](https://github.com/lucidsoftware/lucid-mcp-server/blob/main/FAQ.md) for answers to common questions about how the server works, what it can access, how data is handled, the diagram types it can create, and how it differs from standard text-to-AI connections.
...
- **Issues & feature requests:** [Open an issue](https://github.com/lucidsoftware/lucid-mcp-server/blob/main/../../issues) in this repository
...
[Apache License 2.0](https://github.com/lucidsoftware/lucid-mcp-server/blob/main/LICENSE) © Lucid Software Inc.
