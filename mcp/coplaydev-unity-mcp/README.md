<img width="676" height="380" alt="MCP for Unity" src="https://raw.githubusercontent.com/CoplayDev/unity-mcp/beta/docs/images/logo.png" />

| [English](https://github.com/CoplayDev/unity-mcp/blob/beta/README.md) | [简体中文](https://github.com/CoplayDev/unity-mcp/blob/beta/docs/i18n/README-zh.md) |
|----------------------|---------------------------------|
...
- Security: see [SECURITY.md](https://github.com/CoplayDev/unity-mcp/blob/beta/SECURITY.md) for private reporting

## Contributing

See [CONTRIBUTING.md](https://github.com/CoplayDev/unity-mcp/blob/beta/CONTRIBUTING.md). Branch off `beta`, not `main`. The full dev setup, testing, and release process live in the [Contributing](https://coplaydev.github.io/unity-mcp/contributing/dev-setup) docs.
