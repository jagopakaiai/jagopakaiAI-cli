...
This repository hosts the [`server.json`](https://github.com/lovablelabs/mcp/blob/main/server.json) entry for the [MCP registry](https://registry.modelcontextprotocol.io/).

## License

[Apache License 2.0](https://github.com/lovablelabs/mcp/blob/main/LICENSE)
