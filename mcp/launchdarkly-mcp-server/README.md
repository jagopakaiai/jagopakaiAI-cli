...
For supported JavaScript runtimes, please consult [RUNTIMES.md](https://github.com/launchdarkly/mcp-server/blob/main/RUNTIMES.md).
...
### [AiConfigs](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md)

* [getTargeting](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#gettargeting) - Show an AI Config's targeting
* [updateTargeting](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#updatetargeting) - Update AI Config targeting
* [list](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#list) - List AI Configs
* [create](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#create) - Create new AI Config
* [delete](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#delete) - Delete AI Config
* [get](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#get) - Get AI Config
* [update](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#update) - Update AI Config
* [createVariation](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#createvariation) - Create AI Config variation
* [deleteVariation](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#deletevariation) - Delete AI Config variation
* [getVariation](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#getvariation) - Get AI Config variation
* [updateVariation](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/aiconfigs/README.md#updatevariation) - Update AI Config variation

### [AuditLog](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/auditlog/README.md)

* [listEntries](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/auditlog/README.md#listentries) - List audit log entries

### [CodeReferences](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/codereferences/README.md)

* [listRepositories](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/codereferences/README.md#listrepositories) - List repositories

### [Environments](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/environments/README.md)

* [listByProject](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/environments/README.md#listbyproject) - List environments

### [FeatureFlags](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/featureflags/README.md)

* [getStatus](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/featureflags/README.md#getstatus) - Get flag status across environments
* [list](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/featureflags/README.md#list) - List feature flags
* [create](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/featureflags/README.md#create) - Create a feature flag
* [get](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/featureflags/README.md#get) - Get feature flag
* [patch](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/featureflags/README.md#patch) - Update feature flag
* [delete](https://github.com/launchdarkly/mcp-server/blob/main/docs/sdks/featureflags/README.md#delete) - Delete feature flag
