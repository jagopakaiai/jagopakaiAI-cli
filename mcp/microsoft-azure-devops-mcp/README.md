...
For a comprehensive list of local tools, see [TOOLSET.md](https://github.com/microsoft/azure-devops-mcp/blob/main/docs/TOOLSET.md).
...
For the best experience, use Visual Studio Code and GitHub Copilot. See the [getting started documentation](https://github.com/microsoft/azure-devops-mcp/blob/main/docs/GETTINGSTARTED.md) to use our MCP Server with other tools such as Visual Studio 2022, Codex, Claude Code, Cursor, Opencode, and Kilocode.
...
See the [getting started documentation](https://github.com/microsoft/azure-devops-mcp/blob/main/docs/GETTINGSTARTED.md) to use our MCP Server with other tools such as Visual Studio 2022, Codex, Claude Code, and Cursor.
