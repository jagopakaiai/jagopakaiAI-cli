...
See [examples/dt-config.yaml](https://github.com/dynatrace-oss/dynatrace-managed-mcp/blob/main/examples/dt-config.yaml) and [examples/dt-config.json](https://github.com/dynatrace-oss/dynatrace-managed-mcp/blob/main/examples/dt-config.json) for complete examples.
...
![Architecture (local mode)](https://raw.githubusercontent.com/dynatrace-oss/dynatrace-managed-mcp/main/assets/dynatrace-managed-mcp-arch-local.png?raw=true)

### Remote mode

![Architecture (remote mode)](https://raw.githubusercontent.com/dynatrace-oss/dynatrace-managed-mcp/main/assets/dynatrace-managed-mcp-arch-remote.png?raw=true)
...
non-secret. See [`examples/dt-config-http.yaml`](https://github.com/dynatrace-oss/dynatrace-managed-mcp/blob/main/examples/dt-config-http.yaml) and
[`examples/mcp-config-http.json`](https://github.com/dynatrace-oss/dynatrace-managed-mcp/blob/main/examples/mcp-config-http.json).
...
You can start with something as simple as "Ask Dynatrace to list problems", and follow up with more sophisticated [examples](https://github.com/dynatrace-oss/dynatrace-managed-mcp/blob/main/examples).
