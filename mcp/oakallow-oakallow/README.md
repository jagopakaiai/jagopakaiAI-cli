...
[`SKILL.md`](https://github.com/oakallow/oakallow-mcp/blob/main/SKILL.md) is an agent skill that documents when and how to use the
...
[`PROMPT.md`](https://github.com/oakallow/oakallow-mcp/blob/main/PROMPT.md) has short, copy-paste one-liners to drop into your
...
See [LICENSE](https://github.com/oakallow/oakallow-mcp/blob/main/LICENSE).

## Changelog

See [CHANGELOG.md](https://github.com/oakallow/oakallow-mcp/blob/main/CHANGELOG.md).
