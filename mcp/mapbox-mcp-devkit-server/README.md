...
- [Claude Code Integration](https://github.com/mapbox/mcp-devkit-server/blob/main/docs/claude-code-integration.md) - Command-line development with Claude
- [Claude Desktop Integration](https://github.com/mapbox/mcp-devkit-server/blob/main/docs/claude-desktop-integration.md) - Desktop application integration
- [Cursor Integration](https://github.com/mapbox/mcp-devkit-server/blob/main/docs/cursor-integration.md) - Cursor IDE integration
- [VS Code Integration](https://github.com/mapbox/mcp-devkit-server/blob/main/docs/vscode-integration.md) - Visual Studio Code with GitHub Copilot
...
📖 **[See the Style Builder documentation for detailed usage and examples →](https://github.com/mapbox/mcp-devkit-server/blob/main/docs/STYLE_BUILDER.md)**
...
For complete documentation and usage instructions, see [skills/README.md](https://github.com/mapbox/mcp-devkit-server/blob/main/skills/README.md).
...
See the [mapbox-style-quality skill](https://github.com/mapbox/mcp-devkit-server/blob/main/skills/mapbox-style-quality/SKILL.md) for detailed guidance on when to use validation tools, best practices, and optimization strategies.
...
- **[Complete Tracing Guide](https://github.com/mapbox/mcp-devkit-server/blob/main/docs/tracing.md)** - Detailed configuration, features, and integration examples
- **[Verification Guide](https://github.com/mapbox/mcp-devkit-server/blob/main/docs/tracing-verification.md)** - Step-by-step verification and troubleshooting
...
- **[Engineering Standards (docs/engineering_standards.md)](https://github.com/mapbox/mcp-devkit-server/blob/main/docs/engineering_standards.md)** - Comprehensive guidelines for all contributors
- **[CLAUDE.md](https://github.com/mapbox/mcp-devkit-server/blob/main/CLAUDE.md)** - Architecture and technical patterns
- **[AGENTS.md](https://github.com/mapbox/mcp-devkit-server/blob/main/AGENTS.md)** - Critical patterns and common errors for AI agents
- **[GitHub Copilot Guidelines](https://github.com/mapbox/mcp-devkit-server/blob/main/.github/copilot-instructions.md)** - Copilot-specific development practices
