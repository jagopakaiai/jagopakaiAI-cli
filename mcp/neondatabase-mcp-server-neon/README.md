...
- **`create_branch`**: Creates a new branch within a specified Neon project. Leverages [Neon's branching](https://github.com/neondatabase/mcp-server-neon/blob/main/docs/introduction/branching) feature for development, testing, or migrations.
