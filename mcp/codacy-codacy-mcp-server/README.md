...
2. Make sure you have Agent mode enabled: [vscode://settings/chat.agent.enabled](https://github.com/codacy/codacy-mcp-server/blob/master/vscode:/settings/chat.agent.enabled)
...
![Copilot Agent with Codacy tools](https://raw.githubusercontent.com/codacy/codacy-mcp-server/master/docs/copilot_agent.png)
