...
![Mapbox MCP Server Demo](https://raw.githubusercontent.com/mapbox/mcp-server/main/assets/mapbox_mcp_server.gif)
...
For detailed setup instructions for different clients and API usage, see the [Hosted MCP Server Guide](https://github.com/mapbox/mcp-server/blob/main/docs/hosted-mcp-guide.md).
...
- [Claude Desktop Setup](https://github.com/mapbox/mcp-server/blob/main/docs/claude-desktop-setup.md) - Instructions for configuring Claude Desktop to work with this MCP server
- [Goose Setup](https://github.com/mapbox/mcp-server/blob/main/docs/goose-setup.md) - Setting up Goose AI agent framework
- [VS Code Setup](https://github.com/mapbox/mcp-server/blob/main/docs/vscode-setup.md) - Setting up a development environment in Visual Studio Code
- [Cursor AI IDE Setup](https://github.com/mapbox/mcp-server/blob/main/docs/cursor-setup.md) - Setting up a development environment in Cursor AI IDE
- [Smolagents Integration](https://github.com/mapbox/mcp-server/blob/main/docs/using-mcp-with-smolagents/README.md) - Example showing how to connect Smolagents AI agents to Mapbox's tools
- **[Importing Tools Directly](https://github.com/mapbox/mcp-server/blob/main/docs/importing-tools.md)** - Use Mapbox tools in your own applications without running the MCP server
...
> **Detailed examples:** See [examples/search-along-route.md](https://github.com/mapbox/mcp-server/blob/main/examples/search-along-route.md) for comprehensive examples of the search-along-route prompt with different use cases and MCP Inspector testing instructions.
...
MCP-UI is enabled by default. To disable it, pass `--disable-mcp-ui` as a command-line flag or set `ENABLE_MCP_UI=false`. See the [MCP-UI documentation](https://github.com/mapbox/mcp-server/blob/main/docs/mcp-ui.md) for details.
...
See [docs/tracing.md](https://github.com/mapbox/mcp-server/blob/main/docs/tracing.md) for complete setup instructions including:
...
We welcome contributions to the Mapbox MCP Server! Please read [CONTRIBUTING.md](https://github.com/mapbox/mcp-server/blob/main/CONTRIBUTING.md) before submitting a pull request.

Full standards and guidelines:

- **[CONTRIBUTING.md](https://github.com/mapbox/mcp-server/blob/main/CONTRIBUTING.md)** - Getting started, PR process, quick reference
- **[Engineering Standards (docs/engineering_standards.md)](https://github.com/mapbox/mcp-server/blob/main/docs/engineering_standards.md)** - Complete code quality, testing, documentation, and collaboration standards
- **[Claude Code Guide (CLAUDE.md)](https://github.com/mapbox/mcp-server/blob/main/CLAUDE.md)** - Standards and patterns for contributors using Claude Code
- **[AI Agent Instructions (AGENTS.md)](https://github.com/mapbox/mcp-server/blob/main/AGENTS.md)** - Guide for other AI coding assistants (Cursor, Continue, Aider, etc.)
- **[GitHub Copilot Guidelines](https://github.com/mapbox/mcp-server/blob/main/.github/copilot-instructions.md)** - Best practices for using GitHub Copilot responsibly
...
All contributions must pass our CI checks and code review process. See [docs/engineering_standards.md](https://github.com/mapbox/mcp-server/blob/main/docs/engineering_standards.md) for detailed requirements.
...
[MIT License](https://github.com/mapbox/mcp-server/blob/main/LICENSE.md)
