...
See [More examples for advanced setup](https://github.com/azure-ai-foundry/mcp-foundry/blob/main/clients/README.md) for more details on how to set up the MCP server.
...
See [example .env file](https://github.com/azure-ai-foundry/mcp-foundry/blob/main/clients/python/pydantic-ai/.env.example) for a sample configuration.
