...
Codex plugins are generated locally into `codex-plugins/*/` with the repo marketplace at `.agents/plugins/marketplace.json`. See [Codex Plugins](https://github.com/miroapp/miro-ai/blob/main/docs/codex/overview.md) for the generated structure and [CONTRIBUTING.md](https://github.com/miroapp/miro-ai/blob/main/CONTRIBUTING.md#codex-plugins) for regeneration and local testing.
...
| Plugin | Description |
|--------|-------------|
| [miro](https://github.com/miroapp/miro-ai/blob/main/docs/claude-code/miro.md) | Core MCP integration with 7 bundled skills (browse, code-review, code-spec, code-explain-on-board, diagram, doc, table) |
