...
This guide provides an in-depth look at using, configuring, and troubleshooting the JagoPakaiAI Command Line Interface tool (`jagopakai`).
...
- **Windows**: `C:\Users\<YourUsername>\.config\jagopakai\config.json`
- **macOS / Linux**: `~/.config/jagopakai/config.json`
